...
export const resources: ResourceItem[] = [
  ...
  { id:'e1-instrucciones-pdf', category:'evaluaciones', type:'PDF', title:'E1 · Instrucciones y rúbrica (PDF)', description:'Versión descargable del documento oficial de la Evaluación 1.', status:'Acceso USACH', href:'https://drive.google.com/uc?export=download&id=1HJYVTnCmv6l8e_2y-e5OFa1RMYjfYZlZ', viewHref:'https://drive.google.com/file/d/1HJYVTnCmv6l8e_2y-e5OFa1RMYjfYZlZ/view', actionLabel:'Descargar PDF' },
  { id:'e1-instrucciones-docx', category:'evaluaciones', type:'DOCX', title:'E1 · Instrucciones y rúbrica (DOCX)', description:'Archivo editable original del documento oficial de la Evaluación 1.', status:'Acceso USACH', href:'https://drive.google.com/uc?export=download&id=1Ou9f5XyvNtsfOlwbPxOl4EcoqMhY0Kf5', viewHref:'https://docs.google.com/document/d/1Ou9f5XyvNtsfOlwbPxOl4EcoqMhY0Kf5/edit?usp=drivesdk', actionLabel:'Descargar DOCX' },
